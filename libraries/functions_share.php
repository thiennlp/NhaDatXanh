...
function get_video_youtube($width=2,$height=1,$select=true,$auto=false ){
	...
	if($select){
		$showtext .= '<div data-role="none" class="select_video"><select data-role="none" width="100%" id="video_lienquan">';
		$showtext .='<option data-role="none" value="">Video khác</option>';
...
//get map google api
function get_mapapi($width=2,$height=1,$coor='',$zoom=14){
	$ratio = round($height/$width*100,2);
