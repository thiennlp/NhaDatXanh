<?php  if(!defined('_source')) die("Error");
		...
		if($id!=''){
			...
			$sql = "select ten_$lang,mota_$lang,noidung_$lang,ngaytao,id from #_baiviet where hienthi=1 and tenkhongdau='".$id."'";
			$d->query($sql);
		    ...
		    $d->reset();
		    $sql = "select thumb,id,photo from #_baiviet_photo where hienthi=1 and type='".$type_bar."' and id_baiviet='".$row_detail['id']."' order by stt,id desc ";
		    $d->query($sql);
