...
<form name="supplier" id="validate" class="form" action="index.php?com=follow&act=save" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			<div class="formRight">
                 <input type="hidden" name="id" id="id_this_follow" value="<?=@$item['id']?>" />
