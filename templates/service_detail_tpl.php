...
<link rel="stylesheet" href="js/fotorama/fotorama.css" type="text/css" media="screen" />
    ...
    <div class="khung_pr">
      ...
      <div class="noidung">
        <div class="fotorama" data-width="100%" data-nav="thumbs">
          <?php for ($i=0; $i <count($baiviet_photos) ; $i++) {  ?>
           <img src="<?=_upload_baiviet_l.$baiviet_photos[$i]['photo']?>">
          <?php } ?>
        </div>
